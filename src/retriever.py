...
def hybrid_search(query: str, k: int, chunks_path: str, index_path: str, collection,
    ...
    """Performs hybrid search using BM25 and ChromaDB, deduplicates, and expands chunks."""
    candidates = k * 5
    ...
    final_sources = []
    for source in unique_chunks[:k]:
        content = get_file_content(source.file_path)
        file_len = len(content)
        first, last = source.first_character_index, source.last_character_index
